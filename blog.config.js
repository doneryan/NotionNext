...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https:// www.n8nclub.com.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'n8n, n8n 中文社区', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个奶爸, Hi，我是一个待业老板,Hi，我是一个干饭人,欢迎来到n8n中文社区🎉',
